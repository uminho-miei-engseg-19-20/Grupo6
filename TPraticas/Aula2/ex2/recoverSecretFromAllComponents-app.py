...
#
# Cripto-4.2.3 - Commmad line app to exemplify the usage of recoverSecretFromAllComponents
...
def printUsage():
    print("Usage: python recoverSecretFromAllComponents-app.py total_number_of_shares uid cert.pem")
...
def main(nShares, uid, certificatePath):
    ...
    errorCode, secret = shamirsecret.recoverSecretFromAllComponents(shamirSecretComponents, uid, pemCertificate)
